...
.. image:: ../assets/client_structure.svg
    :alt: uPlatform stack structure with client layer highlight


At the top of the whole uPlatform platform stack sits the client, this components allows interactions with the rest of the stack,
